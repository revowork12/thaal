      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        >
          ...
          <p className="mt-6 text-stone text-base md:text-lg leading-relaxed max-w-xl font-light">
            From the first consultation to the final farewell, Thaal Caterers
              ...
              >
                ...
                <motion.div className="mt-10" custom={3} variants={fadeUp}>
                  <Button
                    variant="outline"
                    size="sm"
                    href="https://wa.me/917907199231?text=Hello%20Thaal%20Caterers%2C%20I%27d%20like%20to%20know%20more%20about%20your%20event%20services."
                    className="group"
                  >

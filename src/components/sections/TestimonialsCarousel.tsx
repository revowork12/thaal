...
const testimonials = [
  {
    quote:
      "Thaal Caterers made our wedding absolutely unforgettable. The attention to detail in every dish was remarkable. Our guests are still raving about the food!",
  ...
  {
    quote:
      "We trusted Thaal Caterers for our religious ceremony, and they exceeded every expectation. Authentic flavors and impeccable service.",
    name: "Ramesh Gupta",

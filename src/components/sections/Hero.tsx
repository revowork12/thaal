    ...
    <section className="relative h-screen min-h-[600px] max-h-[900px] flex items-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8 w-full">
        <div className="max-w-3xl">
          ...
          >
            <span className="inline-block text-gold text-sm md:text-base font-medium uppercase tracking-[0.3em] mb-6">
          ...
          >
            ...
            unforgettable culinary experiences that elevate every moment.
          </motion.p>
          ...
          >
            <Button
              variant="gold"
              size="lg"
              href="https://wa.me/917907199231?text=Hello%20Thaal%20Caterers%2C%20I%27d%20like%20to%20get%20a%20free%20catering%20quote."
            >
              Get Free Quote
            </Button>

...
const testimonials = [
  {
    quote:
      "Thaal Caters made our wedding absolutely unforgettable. The attention to detail in every dish was remarkable. Our guests are still raving about the food weeks after the celebration!",
  ...
  {
    quote:
      "We trusted Thaal Caters for our religious ceremony, and they exceeded every expectation. Authentic flavors, traditional preparations, and impeccable service throughout.",
    name: "Ramesh Gupta",
  ...
  {
    quote:
      "Our company has used Thaal Caters for multiple events now, and they never disappoint. Consistent quality, punctual delivery, and great variety in menus.",
    name: "Rajesh Mehta",
    ...
    <>
      ...
      <section className="py-24 bg-cream">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          >
            <a
              href="https://wa.me/917907199231?text=Hello%20Thaal%20Caters%2C%20I%20want%20to%20share%20my%20feedback%20about%20your%20services."
              target="_blank"

...
const milestones = [
  { year: "2009", title: "The Beginning", description: "Thaal Caterers was founded with a vision to transform catering in the region." },
    ...
    <>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <div className="space-y-4 text-stone leading-relaxed">
                <p>
                  Thaal Caterers began with a simple belief: great food has the
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <SectionHeading
            title="Our Journey"
            subtitle="Key milestones in the Thaal Caterers story"
          />
